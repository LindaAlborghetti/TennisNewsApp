...
public final class QueryUtils {
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            // key called "results", which represents a list of all informations
            // about that news.
            ...
            for (int i = 0; i < results.length(); i++) {
                ...
                // Get a single news at position within the list of news
                ...
                String category = newsObject.getString("sectionName");
                ...
                // Create a new {@link News} object with the title, date, url and category
                // from the JSON response.
                News news = new News(title, author, date, url, category);
